		...
		<![endif]-->
		<!-- Demo purpose jquery.resmenu.min.js only-->
		<script src="<?php echo ASSETS_URL; ?>/js/stanbiccustom.js"></script>
        <script src="<?php echo ASSETS_URL; ?>/js/jquery.resmenu.min.js"></script>
        <script src="<?php echo ASSETS_URL; ?>/js/responsiveslides.min.js"></script>
		<!-- MAIN APP JS FILE -->
