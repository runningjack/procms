...
<html lang="en-us" <?php echo implode(' ', array_map(function($prop, $value) {
	...
	<head>
		...
		<title> <?php echo $page_title != "" ? $page_title." - " : ""; ?>Stanbic IBTC Stockbrokers </title>
        ...
        <link rel='stylesheet' id='font-awesome-corp-styles-css' href='//blog.webguysaz.com/wp-content/plugins/font-awesome-more-icons/assets/css/font-awesome-corp.css?ver=3.5' type='text/css' media='all'/>
        <link rel='stylesheet' id='font-awesome-ext-styles-css' href='//blog.webguysaz.com/wp-content/plugins/font-awesome-more-icons/assets/css/font-awesome-ext.css?ver=3.5' type='text/css' media='all'/>
        <link rel='stylesheet' id='font-awesome-social-styles-css' href='//blog.webguysaz.com/wp-content/plugins/font-awesome-more-icons/assets/css/font-awesome-social.css?ver=3.5' type='text/css' media='all'/>
        <!--[if lte IE 7]>
        <link rel='stylesheet' id='font-awesome-more-ie7-css'  href='//blog.webguysaz.com/wp-content/plugins/font-awesome-more-icons/assets/css/font-awesome-more-ie7.min.css?ver=3.5' type='text/css' media='all' />
        <![endif]-->
				...
				<header id="header">
					...
					<div class="pull-right">
						...
						<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
							<li class="">
								<a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown"> 
									<img src="<?php echo ASSETS_URL; ?>/img/avatars/sunny.png" alt="Admin" class="online" />
								</a>
						...
						<div  class="btn-header transparent pull-right">
							<span> <a href="<?php echo ASSETS_URL ?>/logout" title="Sign Out" ><i class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->
