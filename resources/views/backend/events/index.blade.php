...
$page_nav["events"]["sub"]["list"]["active"] = false;
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <div class="text-right">
                            ...
                            {!!HTML::decode(HTML::linkRoute('addnewevent','<span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span> Add New','new',array("class"=>"btn btn-labeled btn-primary")))!!}
                            {{--@endif--}}
                        </div>
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    {!! HTML::decode(HTML::linkRoute('editevent','<i class="fa fa-edit"></i> Edit',$page->id)) !!}
                                </td>
                                <td>
