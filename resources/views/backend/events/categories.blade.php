...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-code"></i>Events Categories <span>> Listing</span></h1>
    </div>
            ...
            {{ Form::open(array('', 'method'=>'POST', 'class'=>'form-horizontal', "id"=>"regCategory")) }}
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group has-feedback">
                                <input type="hidden" id="type" name="type" value="event category" >
        ...
        var validator = $('#regCategory').validate({
            rules: {
                ...
                $.ajax({url: ''+getRootUrl()+'/backend/events/categories',type: 'post',data: $(form).serialize(),dataType: 'json',
                    success:function(data){if(data){$("div#transProcess").html("<div class='alert alert-info fade in'><button class='close' data-dismiss='alert'>×</button><i class='fa-fw fa fa-check'></i>"+data+"</div>")};setInterval(window.location.reload(),5000);}});
        ...
        $(".datadel").each(function(){
            $(this).click(function(){
                ...
                $.ajax({url: u,type: 'post',data: {id:pgid,action:"delete",_token: $('meta[name="csrf_token"]').attr('content')},dataType: 'json',
                    ...
                    else if(data['status']==500){$(bdmsg).html("<div class='alert alert-info fade in'><button class='close' data-dismiss='alert'>×</button><i class='fa-fw fa fa-check'></i>"+data['data']+"</div>")}}});
                //return false
            })
