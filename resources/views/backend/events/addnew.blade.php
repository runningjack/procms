...
$breadcrumbs["Events"] =url('')."/backend/events/index";
?>
            ...
            <div class="widget-body">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-11">
                            <input class="form-control" required placeholder="New Page Title" id="title" name="title" type="text" value="" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-1 control-label">Url</label>
                        <div class="col-md-11">
                            <input class="form-control" required placeholder="Page Url" id="permalink" name="permalink" type="text" readonly value="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-11">
                            <textarea class="form-control" required  id="description" name="description" rows="4"></textarea>
                        </div>
                    </div>
                </fieldset>
            ...
            <div class="widget-body">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" placeholder="YYYY-MM-DD format for date" id="start_date" name="start_date" type="text" value="" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" placeholder="YYYY-MM-DD format for date" id="end_date" name="end_date" type="text" value="" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control time-inputs" placeholder="Optionally provide a time such as 8:00 am – 2:00 pm" id="start_time" name="start_time" type="text" value="" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">Time (Optional) End</label>
                        <div class="col-md-10">
                            <input class="form-control time-inputs" placeholder="Optionally provide a time such as 8:00 am – 2:00 pm" id="end_time" name="end_time" type="text" value="" autocomplete="off">
                        </div>
                    </div>
                    <hr>
            ...
            <div class="widget-body">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" placeholder="venue of event" id="venue" name="venue" type="text" value="" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" placeholder="Full address" id="address" name="address" type="text" value="" autocomplete="off">
                        </div>
                    </div>
    ...
    <div class="jarviswidget jarviswidget-sortable" id="wid-id-11"  data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" role="widget">
        ...
        <div role="content" class="">
            ...
            <div class="widget-body">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                        <label class="col-md-2 control-label">Event Fee</label>
                        <div class="col-md-10">
                            <input class="form-control" placeholder="event fee" id="fee" name="fee" type="text" value="" autocomplete="off">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="form-group">
                        <div class="col-md-6" style="margin: 0; padding: 0">
                            <input class="form-control" id="sortorder" name="sortorder" placeholder="Sort Order" value="" type="text">
                        </div>
                        <div class="col-md-6" >
    ...
    <div id='inline_content2' style='padding:10px; background:#fff;'>
        ...
        <div id="myTabContent2" class="tab-content padding-10">
            <div class="tab-pane fade in active" id="v1">
                ...
                <input type="hidden" name="faction" id="faction" value="image feature">
                </form>
