...
$page_nav["events"]["sub"]["addnew"]["active"] = false;
...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-code"></i> {{$page_title}} <span>> All Listing</span></h1>
    </div>
...
<div class="jarviswidget jarviswidget-sortable" id="wid-id-9"  data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" role="widget">
    ...
    <header role="heading" class=""><div class="jarviswidget-ctrls" role="menu"><a href="javascript:void(0);" class="button-icon jarviswidget-refresh-btn" data-loading-text="&nbsp;&nbsp;Loading...&nbsp;" rel="tooltip" title="" data-placement="bottom" data-original-title="Refresh"><i class="fa fa-refresh"></i></a>     </div>
        <h2><strong>Date &amp;</strong> <i>Time</i></h2>
        ...
        <div class="widget-body">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" placeholder="YYYY-MM-DD format for date" id="start_date" name="start_date" type="text" value="{{$mypage->start_date}}" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" placeholder="YYYY-MM-DD format for date" id="end_date" name="end_date" type="text" value="{{$mypage->end_date}}" autocomplete="off">
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-md-2 control-label">Time (Optional) Start</label>
                    <div class="col-md-10">
                        <input class="form-control time-inputs" placeholder="Optionally provide a time such as 8:00 am – 2:00 pm" id="start_time" name="start_time" type="text" value="{{$mypage->start_time}}" autocomplete="off">
                    </div>
                </div>


                <div class="form-group">
                    <label class="col-md-2 control-label">Time (Optional) End</label>
                    <div class="col-md-10">
                        <input class="form-control time-inputs" placeholder="Optionally provide a time such as 8:00 am – 2:00 pm" id="end_time" name="end_time" type="text" value="{{$mypage->end_time}}" autocomplete="off">
                    </div>
                </div>
                <hr>
...
<div class="jarviswidget jarviswidget-sortable" id="wid-id-10"  data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" role="widget">
    ...
    <div role="content" class="">
        ...
        <div class="widget-body">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="form-group">
                    <label class="col-md-1 control-label">Venue</label>
                    <div class="col-md-11">
                        <input class="form-control" placeholder="venue of event" id="venue" name="venue" type="text" value="{{$mypage->venue}}" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-11">
                        <input class="form-control" placeholder="Full address" id="address" name="address" type="text" value="{{$mypage->address}}" autocomplete="off">
                    </div>
                </div>
...
<div class="jarviswidget jarviswidget-sortable" id="wid-id-11"  data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" role="widget">
    ...
    <div role="content" class="">
        ...
        <div class="widget-body">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="form-group">
                    <label class="col-md-1 control-label">Event Fee</label>
                    <div class="col-md-11">
                        <input class="form-control" placeholder="event fee" id="fee" name="fee" type="text" value="{{$mypage->fee}}" autocomplete="off">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="jarviswidget jarviswidget-sortable" id="wid-id-13"  data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" role="widget">
        ...
        <div role="content" class="">
            ...
            <div class="widget-body">
                ...
                <div class="radio">
                    <label>
                        <input type="radio" class="radiobox style-0" id="parent_id" @if($category->id == $mypage->parent_id){{"checked"}} @endif name="parent_id"  value="{{$category->id}}" >
            ...
            <div class="widget-body">
                ...
                <div class="col-md-12" style="margin: 0; padding: 0">
                    <div id="imgg" style="background-color: #c3c3c3; padding: 10px; text-align: center">
                        <?php
                        if($mypage->image !=""){
                            echo "<img alt='' src='".url('').'/uploads/images/'.$mypage->image."' width='100' height='100' />";
                        }
                    ...
                    <input type="hidden" id="image" name="image" value="{{$mypage->image}}">
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="form-group">
                        <input class="form-control" id="video" name="video" placeholder="https://vimeo.com/78468485" type="text" value="{{$mypage->video}}">
                    </div>
                </div>
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <div >
                            ...
                            <input type="hidden" id="olddocument" name="olddocument" value="{{$mypage->document}}"
                            <p class="help-block">
