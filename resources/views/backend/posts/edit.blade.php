            ...
            <div class="widget-body">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-11">
                            <input class="form-control" placeholder="New Page Title" id="title" name="title" value="{{$mypage->title}}" type="text" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-1 control-label">Url</label>
                        <div class="col-md-11">
                            <input class="form-control" placeholder="Page Url" id="permalink" name="permalink" type="text" value="{{$mypage->permalink}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-11">
                            <textarea class="form-control"  id="caption" name="caption" rows="4">{{$mypage->caption}}</textarea>
                        </div>
                    </div>
