...
$page_nav["sliders"]["sub"]["list"]["active"] = true;
$breadcrumbs["Sliders"] =""
?>
...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-code"></i> {{$title}} <span>> All Listing</span></h1>
    </div>
</div>
<!-- widget grid -->
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <div class="text-right">
                            ...
                            {!!HTML::decode(HTML::linkRoute('addnewpost','<span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span> Add New','New',array("class"=>"btn btn-labeled btn-primary")))!!}
                            {{--@endif--}}
                        </div>
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    {!! HTML::decode(HTML::linkRoute('editpost','<i class="fa fa-edit"></i> Edit',$page->id)) !!}
                                </td>
                                <td>
